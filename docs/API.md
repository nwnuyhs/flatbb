...
- `icon_paths(): array`
- `avatar(?array $user, int $size = 32, bool $link = true): string` — Avatar image or letter fallback. $user needs id, username, avatar (and display_name for the letter and the tooltip).
