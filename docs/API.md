...
Generated by `php flatbb api:list` on 2026-09-22. Every function below is global and available to plugins.
...
- `notify_wanted(int $to, string $kind): bool` — Whether the member wants this kind of notification (Settings → Preferences). Kinds without a preference are always sent.
