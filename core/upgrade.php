...
{
    return ['index.php', 'flatbb', '.htaccess', 'nginx.conf.example', 'CLAUDE.md', 'AGENTS.md', 'README.md', 'LICENSE', 'core', 'app', 'assets', 'lang', 'docs', 'plugins/hello', 'plugins/market', 'plugins/nav_menu', '.claude', 'tests'];
}
