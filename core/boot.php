...
foreach (['helpers', 'db', 'schema', 'lang', 'auth', 'security', 'verify', 'hook', 'manifest', 'plugin', 'theme', 'theme_dev', 'render', 'markdown', 'upload', 'search', 'cron', 'router', 'points', 'devtools', 'migrate', 'upgrade'] as $file) {
