...
foreach (['helpers', 'db', 'schema', 'lang', 'auth', 'security', 'verify', 'hook', 'manifest', 'plugin', 'theme', 'theme_dev', 'icons', 'render', 'markdown', 'upload', 'ai', 'links', 'search', 'cron', 'router', 'points', 'devtools', 'migrate', 'import', 'upgrade'] as $file) {
