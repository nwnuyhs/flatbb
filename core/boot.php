...
foreach (['helpers', 'db', 'schema', 'lang', 'auth', 'security', 'hook', 'manifest', 'plugin', 'render', 'markdown', 'upload', 'search', 'cron', 'router', 'points', 'devtools', 'migrate', 'upgrade'] as $file) {
