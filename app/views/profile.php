<?php
/**
 * Public profile: a card on the left (avatar, name, labels, bio, buttons, details, numbers, sections from plugins) and the tabs
 * with their lists on the right; plugin cards stack under the card. On a phone the card becomes a compact header above the tabs.
